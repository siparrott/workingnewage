...
const params = z.object({
  sessionId: z.string().optional().describe("Get equipment for a specific session ID"),
  equipmentType: z.string().optional().describe("Filter by equipment type (e.g., 'camera', 'lighting', 'lens')"),
  rentalOnly: z.boolean().optional().describe("If true, only show rental equipment"),
