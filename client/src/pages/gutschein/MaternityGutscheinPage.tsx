...
const MaternityGutscheinPage: React.FC = () => {
  ...
  const packages = [
    {
      ...
      description: 'Schwangerschafts Fotoshooting Basic — 1 bearbeitetes Foto als A3 Leinwand + digital, schöne Erinnerungen',
    ...
    },
    {
      ...
      isFeatured: true,
      description: 'Schwangerschafts Fotoshooting Premium — 5 bearbeitete Fotos digital + A3 Leinwand, umfangreiche Erinnerungen',
      imageUrl: 'https://i.postimg.cc/WzrVSs3F/3-J9-A3679-renamed-3632.jpg'
    },
    {
      title: 'Deluxe',
      ...
      description: 'Schwangerschafts Fotoshooting Deluxe — 10 bearbeitete Fotos digital + A2 Leinwand, das komplette Erlebnis',
      imageUrl: 'https://i.postimg.cc/WzrVSs3F/3-J9-A3679-renamed-3632.jpg'
    }
  ];
  ...
  return (
    <GutscheinLayout
      ...
      seoTitle="Schwangerschafts-Fotoshooting Gutschein Wien – Babybauch-Shooting verschenken | New Age Fotografie"
