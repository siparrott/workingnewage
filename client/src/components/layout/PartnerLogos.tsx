...
const PartnerLogos: React.FC = () => {
  const partners = [
    { url: "https://i.postimg.cc/bJGQXcx9/1626165386655.jpg", alt: "Mattel", link: "https://www.mattel.com" },
    { url: "https://i.postimg.cc/xT9cMVXp/217447.png", alt: "Adidas", link: "https://www.adidas.at" },
    ...
    { url: "https://i.postimg.cc/MHVVT7rc/download-1.png", alt: "UEFA Champions League", link: "https://www.uefa.com" },
    ...
    { url: "https://i.postimg.cc/Qd05HxSq/download-3.png", alt: "Trapport", link: "https://www.trapport.com" },
    ...
    { url: "https://i.postimg.cc/Gpfyx7W8/download-5.png", alt: "DOKA", link: "https://www.doka.com" },
    ...
    { url: "https://i.postimg.cc/g01xZwh3/images.png", alt: "Kleine Herzen", link: "https://www.kleineherzen.at" },
    ...
    { url: "https://i.postimg.cc/xTgqPpHf/kl-herzen-logo4c-ohnetext.jpg", alt: "KL Herzen", link: "https://www.kleineherzen.at" },
    { url: "https://i.postimg.cc/gjWrgfNJ/logo-300x141.png", alt: "Liechtenstein Gruppe", link: "https://www.liechtensteingruppe.at" },
    { url: "https://i.postimg.cc/SRfR3DvG/Porr-svg.png", alt: "Porr", link: "https://www.porr.at" },
    { url: "https://i.postimg.cc/PfWCC558/RB4PRNY.jpg", alt: "smartex", link: "https://www.smartex.at" },
    // New partner logos
    { url: "https://i.postimg.cc/Hx2RcMcL/images.jpg", alt: "OBB", link: "https://www.oebb.at" },
    { url: "https://i.postimg.cc/BbnyxvHB/images.png", alt: "Leier", link: "https://www.leier.at" },
    { url: "https://i.postimg.cc/rwrHG303/Leier-International-logo-svg.png", alt: "Leier International", link: "https://www.leier.at" },
    ...
    { url: "https://i.postimg.cc/66MFBdxj/QAP.png", alt: "QAP", link: "https://www.qap.at" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8">
          {partners.map((partner, index) => (
            <div 
              key={index} 
              className="bg-white rounded-lg p-4 flex items-center justify-center shadow-sm hover:shadow-md transition-shadow relative"
            >
              <img
                src={partner.url}
                alt={partner.alt}
              ...
              />
              {/* Hidden backlink for SEO - not visually clickable */}
              <a
                href={partner.link}
                target="_blank"
