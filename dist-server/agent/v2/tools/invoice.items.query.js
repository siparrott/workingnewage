...
const params = zod_1.z.object({
    invoiceId: zod_1.z.string().optional().describe("Get line items for a specific invoice ID"),
    invoiceNumber: zod_1.z.string().optional().describe("Get line items for a specific invoice number"),
    search: zod_1.z.string().optional().describe("Search in item descriptions"),
    minPrice: zod_1.z.number().optional().describe("Minimum unit price"),
    maxPrice: zod_1.z.number().optional().describe("Maximum unit price"),
