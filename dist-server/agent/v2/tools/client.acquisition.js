...
const params = zod_1.z.object({
    ...
    includeSource: zod_1.z.boolean().default(false).optional().describe("Include breakdown by acquisition source")
});
// Tool definition
const def = {
    ...
    handler: async (ctx, args) => {
      ...
      `;
        ...
        `;
                ...
                response.source_summary = overallSourceResult.rows.map((row) => ({
                    source: row.source,
