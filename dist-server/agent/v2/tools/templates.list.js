...
const params = zod_1.z.object({
    category: zod_1.z.enum(["general", "welcome", "booking", "payment", "gallery", "any"]).default("any").optional().describe("Filter by template category"),
    search: zod_1.z.string().optional().describe("Search in template name or description"),
    limit: zod_1.z.number().int().min(1).max(100).default(50).optional().describe("Maximum number of templates to return")
});
const def = {
    name: "templates_list",
