...
const params = zod_1.z.object({
    category: zod_1.z.enum(["familie", "baby", "hochzeit", "business", "event", "any"]).default("any").optional().describe("Filter by product category"),
    isActive: zod_1.z.boolean().optional().describe("Filter by active status"),
    featured: zod_1.z.boolean().optional().describe("Filter by featured status"),
    search: zod_1.z.string().optional().describe("Search in product name or description"),
    minPrice: zod_1.z.number().optional().describe("Minimum product price"),
    maxPrice: zod_1.z.number().optional().describe("Maximum product price"),
    limit: zod_1.z.number().int().min(1).max(100).default(50).optional().describe("Maximum number of products to return")
});
// Tool definition
const def = {
