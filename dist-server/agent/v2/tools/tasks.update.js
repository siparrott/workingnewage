...
const params = zod_1.z.object({
    ...
    status: zod_1.z.enum(["pending", "in_progress", "completed", "cancelled"]).optional().describe("New status for the task"),
    assignedTo: zod_1.z.string().optional().describe("Assign the task to someone"),
    notes: zod_1.z.string().optional().describe("Add or update task description/notes")
});
const def = {
    name: "tasks_update",
