...
const params = zod_1.z.object({
    clientId: zod_1.z.string().optional().describe("Filter galleries for a specific client ID"),
    isPublic: zod_1.z.boolean().optional().describe("Filter by public (true) or private (false) galleries"),
    isPasswordProtected: zod_1.z.boolean().optional().describe("Filter by password protection status"),
    search: zod_1.z.string().optional().describe("Search in gallery title or description"),
    limit: zod_1.z.number().int().min(1).max(500).default(100).optional().describe("Maximum number of galleries to return")
});
// Tool definition
const def = {
    name: "galleries_list",
