...
exports.PDFReportAdapter = void 0;
const crypto_1 = require("crypto");
const pdfkit_1 = __importDefault(require("pdfkit"));
class PDFReportAdapter {
    constructor() {
        this.name = 'PDF Invoice Report';
        this.profile = 'pdf_invoice_report';
        this.description = 'Professional PDF report with all invoices and line items';
        this.version = '1.0.0';
    }
    /**
    ...
    transform(data) {
        ...
        const checksum = (0, crypto_1.createHash)('sha256').update(pdfBuffer).digest('hex');
        return [
            {
    ...
    generatePDF(data) {
        return new Promise((resolve, reject) => {
            ...
            for (let i = 0; i < pageCount; i++) {
                ...
                doc.text(`Page ${i + 1} of ${pageCount} - Generated: ${new Date().toISOString().split('T')[0]}`, 50, doc.page.height - 50, { align: 'center' });
            }
            doc.end();
        });
    }
...
exports.PDFReportAdapter = PDFReportAdapter;
